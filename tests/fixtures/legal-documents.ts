  ...
  sections: [
    {
      heading: '一、协议范围',
      paragraphs: [
        '本协议由你与“今晚吃什么”的运营者刘彦龙共同订立。使用本小程序前，请完整阅读并理解本协议。',
  ...
  sections: [
    {
      heading: '一、我们是谁',
      paragraphs: [
        '“今晚吃什么”的个人信息处理者为刘彦龙。如需咨询、查阅、更正、删除个人信息或投诉，请联系15203700590@163.com。',
      ],
    },
    {
      heading: '二、我们处理的信息',
    ...
    },
    {
      heading: '六、你的权利',
      paragraphs: [
        '你可以通过15203700590@163.com申请查阅、更正、复制或删除相关个人信息，也可以提出隐私咨询或投诉。我们可能需要验证你的身份后处理请求。',
