...
主体姓名核验已完成：管理员已确认代码中的运营主体“刘彦龙”与微信公众平台实名认证姓名逐字一致。隐私联系邮箱保持为 `15203700590@163.com`。

1. 两份原生法律页已经实现；管理员仍须人工核对法律文案与真实功能，并在微信公众平台人工完成《用户隐私保护指引》和最小化隐私接口声明。
2. 管理员须人工确认正式名称、服务类目、主体、开发者、体验成员和审核材料。
3. 管理员须明确授权并亲自或监督完成新后端部署、新体验代码上传，以及两个真实账号在至少一台 iPhone、一台 Android 和弱网下的完整回归。
4. 管理员须人工确认数据库备份恢复、日志脱敏、限流、告警、故障联系人、JAR 备份和回滚流程。
...
2. 主体姓名“刘彦龙”已由管理员确认与微信实名认证姓名逐字一致；下一步按 `docs/wechat-privacy-guide-materials.md` 人工配置并核对微信《用户隐私保护指引》和最小化隐私接口声明。
3. 只有在管理员明确授权并亲自或监督时，才可登录微信公众平台核对正式名称、服务类目、开发者和体验成员；代理不得自行操作平台。
...
1. 已完成：管理员确认代码中的运营主体“刘彦龙”与微信实名认证的个人主体姓名逐字一致；隐私联系邮箱保持 `15203700590@163.com`。两份法律页和平台最终内容仍须在提审前整体复核。
...
- **运营主体“刘彦龙”已由管理员确认与微信公众平台实名认证姓名逐字一致；隐私联系邮箱为 `15203700590@163.com`。两份法律页和平台最终内容仍须在提审前整体复核。**
